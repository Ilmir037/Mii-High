proc/updateworld()
	if(autohost==0)
		world.status={"<font color=[hostedcolor]>[worldstatus]<b>Mii High</b>]<b>RP Mode: <br>[rpmode]</b><br><b>Game Map:</b> [mapp]<BR><b>Game Mode:</b> [gamemode]<BR><b>Players:</b> [playersjoined]/[maxplayers]"}
	else
		world.status={"<font color=[hostedcolor]>[worldstatus]<b>Mii High</b>]<b>RP Mode: <br>[rpmode]</b><br><b>Game Map:</b> [mapp]<BR><b>Auto Hosting:</b> Enabled<BR><b>Game Mode:</b> [gamemode]<BR><b>Players:</b> [playersjoined]/[maxplayers]"}
